...
namespace UsersService.Infrastructure.Persistence.Redis
{
    public class RedisKeyValueManager : IKeyValueManager
    {
        ...
        public async Task<string?> GetRegistrationCodeAsync(
            string login, 
            CancellationToken cancellationToken = default
        )
        {
        ...
        public async Task<string?> GetResetPasswordCodeAsync(
            string login, 
            CancellationToken cancellationToken = default
        )
        {
        ...
        public async Task SetRegistrationCodeAsync(
            string key, 
            string value, 
            CancellationToken cancellationToken = default
        )
        ...
        public async Task SetResetPasswordCodeAsync(
            string key, 
            string value, 
            CancellationToken cancellationToken = default
        )
