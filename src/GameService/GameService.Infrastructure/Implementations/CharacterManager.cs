...
namespace GameService.Infrastructure.Implementations
{
    public class CharacterManager : ICharacterManager
    {
        ...
        public Task<PointsConfigurationDto> GetPointsConfigurationAsync(CancellationToken cancellationToken = default)
        {
        ...
        public async Task<bool> ValidateCharacterPointsAsync(CharacterEntity characterEntity, CancellationToken cancellationToken = default)
        {
